...
public:
    ...
    void DeleteSelectionItem(const int index);
...
protected:
    ...
    int mSelectedItemIndex;            //zero-based index that tells what item is currently highlighted (soft selected)
    int mConfirmedSelectedItemIndex;   //zero-based index that tells what item was last confirm-selected (hard selected)

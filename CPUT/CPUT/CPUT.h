...
#include <GLES3/gl3ext.h>             // OpenGL ES 2.0 Extensions 
#else
...
//-----------------------------------------------------------------------------
    ...
    inline char* ws2s(std::wstring string)
    {
        ...
        LOGI("ws2s in str %s", string.c_str());

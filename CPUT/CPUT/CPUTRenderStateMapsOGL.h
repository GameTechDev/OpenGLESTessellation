...
static const CPUTRenderStateMapEntry pDepthStencilDescMap[] =
{
    ...
    { CONVERTTYPE("depthwritemask"),              ePARAM_TYPE_OGL_ENUM,              (UINT)offsetof(CPUT_DEPTH_STENCIL_DESC, DepthWriteMask)},
...
static const StringToIntMapEntry pOGLBlendMap[] = {
	...
	{ CONVERTTYPE("gl_one_minus-dst_color"),    GL_ONE_MINUS_DST_COLOR },

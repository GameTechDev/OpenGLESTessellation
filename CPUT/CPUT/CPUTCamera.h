...
enum CPUT_CAMERA_TYPE {
    CPUT_CAMERA_TYPE_PERSPECTIVE,
    CPUT_CAMERA_TYPE_ORTHOGRAPHIC
};

#define ASSERT_ORTHOGRAPHIC ASSERTA(mType == CPUT_CAMERA_TYPE_ORTHOGRAPHIC, "Camera not orthographic.");
#define ASSERT_PERSPECTIVE  ASSERTA(mType == CPUT_CAMERA_TYPE_PERSPECTIVE,  "Camera not perspective.");

//-----------------------------------------------------------------------------
class CPUTCamera:public CPUTRenderNode
{
protected:
    CPUT_CAMERA_TYPE mType;
...
public:
    ...
    CPUTCamera( CPUT_CAMERA_TYPE type = CPUT_CAMERA_TYPE_PERSPECTIVE) : 
    ...
    CPUT_CAMERA_TYPE GetType()                 const { return mType; }
    ...
    float            GetHeight()               const { ASSERTA(mType == CPUT_CAMERA_TYPE_ORTHOGRAPHIC, "Camera not orthographic."); return mHeight; }
    ...
    void             SetType(CPUT_CAMERA_TYPE type)                  { mType = type; mFov = 0.0f; }

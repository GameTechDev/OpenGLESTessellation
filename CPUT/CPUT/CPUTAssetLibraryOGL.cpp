...
/*
// Retrieve specified compute shader
//-----------------------------------------------------------------------------
...
)
{
    ...
    // see if the shader is already in the library
    void *pShader = FindHullShader(libName + shaderMain + shaderProfile, true);
    if(NULL!=pShader)
    {
...
)
{
    ...
    // see if the shader is already in the library
    void *pShader = FindDomainShader(libName + shaderMain + shaderProfile, true);
    if(NULL!=pShader)
    {
...
)
{
    ...
    // see if the shader is already in the library
    void *pShader = FindGeometryShader(libName + shaderMain + shaderProfile, true);
    if(NULL!=pShader)
    {

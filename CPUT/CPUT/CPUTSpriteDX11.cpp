...
//-----------------------------------------------
CPUTSpriteDX11* CPUTSpriteDX11::CreateSprite(
    float          spriteX,
    float          spriteY,
    float          spriteWidth,
    float          spriteHeight,
...
)
{
    ...
    CPUTVertexShaderDX11 *pVertexShader = ((CPUTMaterialEffectDX11*)pCPUTSprite->mpMaterial->GetMaterialEffects()[0])->GetVertexShader();
...
//-----------------------------------------
void CPUTSpriteDX11::DrawSprite(

...
public:
    ...
    CPUTMaterialEffect *FindMaterialEffect(                 const cString &name, bool nameIsFullPathAndFilename=false, const char **pShaderMacros=NULL, const CPUTModel *pModel=NULL, int meshIndex=-1) { return (CPUTMaterialEffect*)        FindAsset( name, mpMaterialEffectList,         nameIsFullPathAndFilename, pShaderMacros, pModel, meshIndex ); }
    ...
    CPUTMaterialEffect   *GetMaterialEffect(  const cString &name, bool nameIsFullPathAndFilename=false, const CPUTModel *pModel=NULL, int meshIndex=-1, const char **pShaderMacros=NULL);

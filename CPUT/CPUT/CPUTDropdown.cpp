...
//-----------------------------------------------------------------------------
void CPUTDropdown::SetSelectedItem(const int index)
{
    if( (index>-1) && (index < mpListOfSelectableItems.size() ))
    {
...
//-----------------------------------------------------------------------------
void CPUTDropdown::DeleteSelectionItem(const int index)
{
